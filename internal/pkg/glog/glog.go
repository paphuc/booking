...
// booking is a logger implementation
type booking struct {
	logger *logrus.Entry
...
func (l *booking) Infof(format string, v ...interface{}) {
	l.logger.Infof(format, v...)
}

// Debugf print debug with format.
func (l *booking) Debugf(format string, v ...interface{}) {
	l.logger.Debugf(format, v...)
}

// Warnf print warning with format.
func (l *booking) Warnf(format string, v ...interface{}) {
	l.logger.Warnf(format, v...)
}

// Errorf print error with format.
func (l *booking) Errorf(format string, v ...interface{}) {
	l.logger.Errorf(format, v...)
}

// Panicf panic with format.
func (l *booking) Panicf(format string, v ...interface{}) {
	l.logger.Panicf(format, v...)
}

// Infoc print info log with context
func (l *booking) Infoc(ctx context.Context, format string, v ...interface{}) {
	l.withContext(ctx).Infof(format, v...)
}

// Debugc print debug with context
func (l *booking) Debugc(ctx context.Context, format string, v ...interface{}) {
	l.withContext(ctx).Debugf(format, v...)
}

// Warnc print warning with context
func (l *booking) Warnc(ctx context.Context, format string, v ...interface{}) {
	l.withContext(ctx).Warnf(format, v...)
}

//Errorc print error with context
func (l *booking) Errorc(ctx context.Context, format string, v ...interface{}) {
	l.withContext(ctx).Errorf(format, v...)
}

// Panicc panic with context
func (l *booking) Panicc(ctx context.Context, format string, v ...interface{}) {
	l.withContext(ctx).Panicf(format, v...)
}

func (l *booking) withContext(ctx context.Context) Logger {
...
func (l *booking) WithField(field string, value interface{}) Logger {
